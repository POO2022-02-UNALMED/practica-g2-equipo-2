...
class VentanaInicio(tk.Tk):
    def __init__(self):
        ...
        self.icon = 0
        self.prb = tk.PhotoImage(file=path+"/fotos/sistema/1.png")
        ...
        self.fotos = 0
        self.fotosCamila=[]
        self.fotosCamila.append(tk.PhotoImage(file=path+"/fotos/camila/1.png")) 
        self.fotosCamila.append(tk.PhotoImage(file=path+"/fotos/camila/2.png"))  
        self.fotosCamila.append(tk.PhotoImage(file=path+"/fotos/camila/3.png"))  
        self.fotosCamila.append(tk.PhotoImage(file=path+"/fotos/camila/4.png"))
        self.fotosSebastian=[]
        self.fotosSebastian.append(tk.PhotoImage(file=path+"/fotos/sebastian/1.png")) 
        self.fotosSebastian.append(tk.PhotoImage(file=path+"/fotos/sebastian/2.png"))  
        self.fotosSebastian.append(tk.PhotoImage(file=path+"/fotos/sebastian/3.png"))  
        self.fotosSebastian.append(tk.PhotoImage(file=path+"/fotos/sebastian/4.png"))
        self.fotosAlejandro=[]
        self.fotosAlejandro.append(tk.PhotoImage(file=path+"/fotos/alejandro/1.png")) 
        self.fotosAlejandro.append(tk.PhotoImage(file=path+"/fotos/alejandro/2.png"))  
        self.fotosAlejandro.append(tk.PhotoImage(file=path+"/fotos/alejandro/3.png"))  
        self.fotosAlejandro.append(tk.PhotoImage(file=path+"/fotos/alejandro/4.png"))
        self.fotosHans=[]
        self.fotosHans.append(tk.PhotoImage(file=path+"/fotos/hans/1.png")) 
        self.fotosHans.append(tk.PhotoImage(file=path+"/fotos/hans/2.png"))  
        self.fotosHans.append(tk.PhotoImage(file=path+"/fotos/hans/3.png"))  
        self.fotosHans.append(tk.PhotoImage(file=path+"/fotos/hans/4.png"))
    ...
    def cambiarIcono(self,event):
        if(self.icon==0):
            self.icon = 1
            self.prb['file'] = path+"/fotos/sistema/2.png"
        elif(self.icon==1):
            self.icon = 2
            self.prb['file'] = path+"/fotos/sistema/3.png"
        elif(self.icon==2):
            self.icon = 3
            self.prb['file'] = path+"/fotos/sistema/4.png"
        else:
            self.icon = 0
