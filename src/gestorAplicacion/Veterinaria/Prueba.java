...
public class Prueba {
    public static void main(String[] args){
        ...
        Diagnostico diag1 = new Diagnostico("23/10/2022", julian, felipe, toby, "Se realiza consulta de medicina veterinaria por paciente el cual su dueño expresa que tiene parasitos, dolor y inflamacion.");
        diag1.Diagnos();
